...
-- Полностью совпадают 495 из 730
 select count(*) n
  from "Бирюлёвский дендропарк"."№№ пл. сводка адресов"
...
INSERT INTO "Бирюлёвский дендропарк"."№№ пл. нет коллизий" ("Адрес","Причина") VALUES
     ...
     ('55×6¹*','отдалённая часть, не является отдельной ботанической единицей'),
     ('51×9*','комплексная площадка из 4-х частей'),
     ('51×9в*','отдалённая часть, не является отдельной ботанической единицей'),
     ('51×9с₁*','отдалённая часть, не является отдельной ботанической единицей'),
     ('51×9с₂*','отдалённая часть, не является отдельной ботанической единицей'),
     ('51×9ю*','отдалённая часть, не является отдельной ботанической единицей'),
...
-- Коллизии списков, не являющиеся ошибками 47
 select count(*) n
  from "Бирюлёвский дендропарк"."№№ пл. сводка адресов"
 where not (wiki is not null and "ОКН"  is not null and "ОСМ"  is not null and "каталог Дмитрия" is not null)
...
-- Обзорная сводка
select "Адрес", wiki, "ОКН", "ОСМ", "каталог Дмитрия", "каталог табличек", "объектов OSM", "URL"
  from "Бирюлёвский дендропарк"."№№ пл. сводка адресов"
order by coalesce("Уч. w", "Уч. ОКН", "Уч. ОСМ", "Уч. Дм") asc,
coalesce("№ w", "№ ОКН", "№ ОСМ", "№_ Дм") asc